...
void Widget::SetColor(Widget::ColorType type, float r, float g, float b, float a)
{
	...
	case TEXT_INACTIVE_COLOR:
		...
		break;
	default:
		throw System::Exception(L"Bad color type" + LOG_LOCATION_STRING);
	}
...
void Widget::SetVideoDriver(Driver::Video* driver)
{
	//g_driver = driver;
}
...
void Widget::SetBackGroundTexture(Driver::Texture2D* texture)
{
