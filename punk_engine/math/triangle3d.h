...
namespace Math
{
	...
	LIB_MATH IntersectionType LineCrossTriangle(const Line3D& e, const Triangle3D& p, float& t);
	LIB_MATH Point3DPositionClassification Classify(const vec3& v, const Triangle3D& t);
}
