/*
	File: StaticMeshWithSpecular2.h"
...
*/
#ifndef _H_STATIC_MESH_WITH_SPECULAR2
#define _H_STATIC_MESH_WITH_SPECULAR2

class StaticMeshWithSpecular2
{
public:
	StaticMeshWithSpecular2(int vCount, int fCount, float* v, float* t, float* n, unsigned short* i);
	~StaticMeshWithSpecular2();
	...
	static StaticMeshWithSpecular2* CreateFromFile(const char* filename);
private:
	void InternalDraw_v1();
	void InternalDraw_v2();	
};

#endif //	_H_STATIC_MESH_WITH_SPECULAR2