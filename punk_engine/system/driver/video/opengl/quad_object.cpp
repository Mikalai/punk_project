...
namespace OpenGL
{
	...
	//	vbuffer[0].u = 0;		vbuffer[0].v = 0;		vbuffer[0].s = 0; vbuffer[0].t = 1;
		vbuffer[1].x = 0.5;		vbuffer[1].y = -0.5;	vbuffer[1].z = z; vbuffer[1].w = 1;
	//	vbuffer[1].u = 1;		vbuffer[1].v = 0;		vbuffer[1].s = 0; vbuffer[1].t = 1;
	...
	//	vbuffer[3].u = 1;		vbuffer[3].v = 0;		vbuffer[3].s = 0; vbuffer[3].t = 1;
		...
		impl_vao->Cook(VERTEX_POSITION, GL_TRIANGLES);
	}
}