...
namespace Render
{
	TerrainRender* g_render = 0;

	TerrainRender* TerrainRender::GetRender()
	{
		if (g_render)
			return g_render;
		g_render = new TerrainRender();
		return g_render;
	}

	std::queue<TerrainRender::Parameters*> TerrainRender::Parameters::parametersPool;

    void TerrainRender::Parameters::Release()
    {
        this->parametersPool.push(this);
    }

    TerrainRender::Parameters* TerrainRender::Parameters::Create()
    {
