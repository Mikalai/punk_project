...
namespace System
{
	...
	{
		return m_is_launched = CreateProcessW(NULL, cmd_line.I_know_what_I_do_just_give_me_the_pointer(), NULL, NULL, TRUE, 0, 0, 0, &m_startup_info.StartupInfo, &m_process_info);
	}
