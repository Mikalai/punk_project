...
namespace Gpu
{
    namespace OpenGL
    {
        VsPvltdShadowSingle::VsPvltdShadowSingle()
            : Shader(ShaderType::Vertex)
        {
            CookFromFile(System::Environment::Instance()->GetShaderFolder()
                         + GetShaderFile(ShaderCollection::VertexShadow));
        }

        void VsPvltdShadowSingle::InitUniforms()
        {
...
//            }
        ...
        void VsPvltdShadowSingle::BindParameters(const CoreState& params)
        {
...
//            }
        ...
        int64_t VsPvltdShadowSingle::GetRequiredAttributesSet() const
        {
