...
namespace OpenGL
{
	...
	//	if ( loc < 0 )
	//	{
	//		out_error() << L"Can't set uniform parameter: " + System::string(name) << std::endl;
	//		return false;
	//	}
	...
	//	if ( loc < 0 )
	//	{
	//		out_error() << L"Can't get uniform parameter: " + System::string(name) << std::endl;
	//		return;
	//	}
	...
	//	if ( index < 0 )
	//	{
	//		out_error() << L"Can't set attribute: " + System::string(name) << std::endl;
	//		return false;
	//	}
	...
	//	if ( index < 0 )
	//	{
	//		out_error() << L"Can't get attribute: " + System::string(name) << std::endl;
	//		return;
	//	}
