...
//						{
//							std::unique_ptr<OpenGL::RenderContextBumpMapping::PolicyParameters> p(new OpenGL::RenderContextBumpMapping::PolicyParameters);
...
//
//							std::unique_ptr<OpenGL::Batch> batch(new OpenGL::Batch);
